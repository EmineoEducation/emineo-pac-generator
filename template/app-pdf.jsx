...
const pdfStyles = {
  ...
  toolbar: { display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', background: 'linear-gradient(180deg, #f0eee8, #e0ded8)', borderBottom: '1px solid rgba(0,0,0,0.15)', flexShrink: 0 },
  ...
  thumbCol: { width: 110, flexShrink: 0, background: '#2a2e36', padding: '12px 8px', display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'center' },
  ...
  pageWrap: { flex: 1, padding: '28px 40px', overflowY: 'auto', display: 'flex', justifyContent: 'center' },
  page: { width: '100%', maxWidth: 580, background: 'white', padding: '50px 56px', boxShadow: '0 4px 20px rgba(0,0,0,0.4)', fontFamily: 'Georgia, var(--font-display), serif', minHeight: 720, position: 'relative' },
